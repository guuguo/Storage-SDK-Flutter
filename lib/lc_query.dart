...
class LCQuery<T extends LCObject> {
  ...
  Future<int?> count() async {
    ...
    params['limit'] = 0;
    params['count'] = 1;
    Map result = await (LeanCloud._httpClient.get(path, queryParams: params) as FutureOr<Map<dynamic, dynamic>>);
    return result['count'];
  }
  ...
  Future<List<T>> _fetch(CachePolicy cachePolicy) async {
    ...
    Map response = await (LeanCloud._httpClient
        .get(path, queryParams: params, cachePolicy: cachePolicy) as FutureOr<Map<dynamic, dynamic>>);
